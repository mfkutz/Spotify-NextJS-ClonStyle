...
const Card = () => {
	return (
		<Link
			href='/'
			className='bg-spotify-lightgray p-4 rounded-lg hover:bg-spotify-lightgrayHover transition-all duration-300 group -z-10'
		>
			...
			<div>
				<h5 className='font-medium text-gray-200 text-lg mb-2'>
					Today's Top Guitar
				</h5>
				<p className='text-gray-200 text-sm w-[18ch]'>
					YMN in on top of the 10!
				</p>
			</div>
		</Link>
	)
