...
import { RiSearchLine, RiHome4Fill, RiBuilding2Fill, RiAddBoxFill, RiHeartFill, RiCloseFill } from "react-icons/ri"
...
const Sidebar = () => {
  ...
  return (
    <div className={`bg-black fixed top-0 w-64 h-full p-6 flex flex-col justify-between  md:left-0 ${menuOpen ? 'left-0 transition-all duration-300' : '-left-full md:left-0 transition-all duration-300 '}`}>
